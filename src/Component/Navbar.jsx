...
const Navbar = () => {
    return (
        ...
        <nav className="navbar navbar-expand-lg bg-body-tertiary d-flex bg-white align-items-center justify-content-center justify-content-xl-evenly">
            <img src='https://s3-alpha-sig.figma.com/img/153c/f988/785cdcec05510cbdc9cb1b82a17b77fc?Expires=1707091200&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=RwDBvd7~VSgMshB8aytt3IspIoS~D0d~UhZWRQoXLvrkeT7htGuNoGLm0i~W-bagwnYGS46JEdaKSc2SHv~2-Tkfyg~taNo412tZwiLo1SxNuCt052dA6sWASfaAAHvecOQ~z8kYV8horkXZWkAfMuQ8CS85ns~ThUpvUAhxvVgOn~4NwSJgjJBnsGJJ6CZlKxn83HhnaNO320SYHE2U16d4xk-dpM4IhVuixcBHRTkvF89ftStgtd1qEZb6u9HB45zZUP7THOXWISMx-6M2H1UlEzAhwn4uRGBuNbsxtzVjE3BQgN8n6yfuJvttREk2Kl87dr4G7F3gMNFY4kiJZA__' width={293.258} height={60} className=' mx-lg-5' />
                ...
                <div className="collapse navbar-collapse mx-lg-5 " id="navbarSupportedContent">
                    <ul className="navbar-nav me-auto mb-2 mb-lg-0 ">
                        ...
                        <li className="nav-item dropdown mx-lg-5 d-flex flex-row justify-content-center align-items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                <path d="M12.5 3L20.7272 7.75V17.25L12.5 22L4.27276 17.25V7.75L12.5 3Z" fill="#8064A2" />
                            </svg>
                            <a className="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                Hobbies
                            </a>
                            <ul className="dropdown-menu mx-lg-5">
                                <li><a className="dropdown-item mx-2" href="#">Action</a></li>
                                <li><a className="dropdown-item mx-2" href="#">Another action</a></li>
                                <li><hr className="dropdown-divider" /></li>
                                <li><a className="dropdown-item mx-2" href="#">Something else here</a></li>
                            </ul>
                        </li>
                        <div className='d-flex align-items-center justify-content-center mx-4'>
                            <i className="bi bi-bookmark-fill mx-2" height='24px' width='24px'></i>
                            <i className="bi bi-bell-fill mx-2" height='24px' width='24px'></i>
                            <i className="bi bi-cart-fill mx-2" height='24px' width='24px'></i>
                        </div>

                        <form className="d-flex" role="search">
                            <button className="btn btn-outline-success  mx-4" type="submit">Sign In</button>
                        </form>
                    </ul>
